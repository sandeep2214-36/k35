...
const sem=currentUser.semester?` | Semester: ${currentUser.semester}`:"";
document.getElementById("stuHomeDept").innerText=`Department: ${currentUser.department||"—"} | Roll: ${currentUser.roll||"—"}${sem}`;
