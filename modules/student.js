...
const yr=currentUser.year||currentUser.semester;
const yrLine=yr?` | Year: ${yr}`:"";
document.getElementById("stuHomeDept").innerText=`Department: ${currentUser.department||"—"} | Roll: ${currentUser.roll||"—"}${yrLine}`;
